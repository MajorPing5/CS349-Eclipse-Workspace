...
public class InventoryView extends JFrame {
	...
	private void toggleFieldsEdit(ArrayList<JTextField> fields, boolean status) {
	 ...
	 * @param testedField A list of strings for all tested field(s)
	 * @returns Error Message
	 */
	public void failedEntry(String failType, String testedField) {
		switch (failType) {

		// By far the most-likely and widely applicable error that can take place
		case "Blank": 
			JOptionPane.showMessageDialog(null,
					"Empty Field(s) Detected: " + testedField,
		...
		case "Not An Integer":
			JOptionPane.showMessageDialog(null,
					"Invalid Integer Entry: " + testedField,
					"Error", JOptionPane.ERROR_MESSAGE);
			break;
		case "Integer Domain Violation":
			JOptionPane.showMessageDialog(null,
					"Your " + String.join(" , ", testedField) + " can't be < 0!",
					"Error", JOptionPane.ERROR_MESSAGE);
			break;
		...
		default:
			JOptionPane.showMessageDialog(null,
					...
					" with field(s) " + String.join(", ", testedField),
					"Error", JOptionPane.ERROR_MESSAGE);
		}
	}
}